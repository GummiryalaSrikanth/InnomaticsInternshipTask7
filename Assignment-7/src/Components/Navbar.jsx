      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/" className="text-gray-700 hover:text-blue-600 hover:underline transition-colors">Home</Link>
            <Link to="/courses" className="text-gray-700 hover:text-blue-600 hover:underline  transition-colors">Courses</Link>
            <Link to="/services" className="text-gray-700 hover:text-blue-600 hover:underline transition-colors">Services</Link>
            <Link to="/about" className="text-gray-700 hover:text-blue-600 hover:underline transition-colors">About</Link>
            <Link to="/contact" className="text-gray-700 hover:text-blue-600 hover:underline transition-colors">Contact</Link>
